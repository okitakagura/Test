...

{
	...
	CCMenuItemToggle *toggle = CCMenuItemToggle::createWithTarget(this, menu_selector(StartScene::SoundOnOffClick), soundbtnOn, soundbtnOff, NULL);
...
void StartScene::SoundOnOffClick(cocos2d::Ref* pSender)
{
	if (isSoundOpen)
	{
